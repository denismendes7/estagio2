...
require_once("DAO/EmpresaCriteriaDAO.php");

/**
 * The EmpresaCriteria class extends EmpresaDAOCriteria and is used
 ...
 * @version 1.0
 */
class EmpresaCriteria extends EmpresaCriteriaDAO
{
