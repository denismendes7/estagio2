...
require_once("DAO/PFacebookCriteriaDAO.php");

/**
 * The PFacebookCriteria class extends PFacebookDAOCriteria and is used
 ...
 * @version 1.0
 */
class PFacebookCriteria extends PFacebookCriteriaDAO
{
