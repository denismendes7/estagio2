...
require_once("DAO/PerfilSmsCriteriaDAO.php");

/**
 * The PerfilSmsCriteria class extends PerfilSmsDAOCriteria and is used
 ...
 * @version 1.0
 */
class PerfilSmsCriteria extends PerfilSmsCriteriaDAO
{
