...
require_once("DAO/RelacaoAcessoCriteriaDAO.php");

/**
 * The RelacaoAcessoCriteria class extends RelacaoAcessoDAOCriteria and is used
 ...
 * @version 1.0
 */
class RelacaoAcessoCriteria extends RelacaoAcessoCriteriaDAO
{
