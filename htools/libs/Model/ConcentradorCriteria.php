...
require_once("DAO/ConcentradorCriteriaDAO.php");

/**
 * The ConcentradorCriteria class extends ConcentradorDAOCriteria and is used
 ...
 * @version 1.0
 */
class ConcentradorCriteria extends ConcentradorCriteriaDAO
{
