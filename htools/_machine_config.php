...
GlobalConfig::$CONNECTION_SETTING->DBName = "htools";
GlobalConfig::$CONNECTION_SETTING->Username = "denis";
GlobalConfig::$CONNECTION_SETTING->Password = "12345";
...
/** the root url of the application with trailing slash, for example http://localhost/htools/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'htools/';
