<?php
	$this->assign('title','Htools | Usuarios');
				...
				<div id="sexoInputContainer" class="control-group">
					...
					<div class="controls inline-inputs">
						<select id="sexo" name="sexo">
							<option value=""></option>
							<option value="F"<% if (item.get('sexo')=='F') { %> selected="selected"<% } %>>F</option>
							<option value="M"<% if (item.get('sexo')=='M') { %> selected="selected"<% } %>>M</option>
						</select>
						<span class="help-inline"></span>
					</div>
				</div>
