...
var page = {
	...
	updateModel: function() {
		...
		page.usuario.save({
			...
			success: function(){
				...
				setTimeout("app.appendAlert('Usuario " + (isNew ? "inserido" : "atualizado") +  " com sucesso " + "','alert-success',3000,'collectionAlert')",500);
				app.hideProgress('modelLoader');
	...
	deleteModel: function()	{
		...
		page.usuario.destroy({
			...
			success: function(){
				$('#usuarioDetailDialog').modal('hide');
				setTimeout("app.appendAlert('O Usuario registro foi deletado','alert-success',3000,'collectionAlert')",500);
				app.hideProgress('modelLoader');
